...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFF0DB22E;//指示线的颜色#006BCE

    private int underlineColor = 0x1A000000;

    private int dividerColor = 0x1A000000;

    private boolean shouldExpand = true;//修改页签的大小是适应屏幕还是,固定大小滑动
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextColor(i == 0 ? getResources().getColor(R.color.green) : tabTextColor);
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == pager.getCurrentItem() ? getResources().getColor(R.color.green) : tabTextColor);
                }
            }
        }
    }
